...
def create_datasets(tokenizer, data_args, training_args, apply_chat_template):
    # Load dataset
    dataset = load_dataset('csv', data_files={'train': data_args.dataset_name, 'test': data_args.dataset_name})
    ...
    def tokenize_function(examples):
        return tokenizer(examples[data_args.dataset_text_field], padding="max_length", truncation=True,
